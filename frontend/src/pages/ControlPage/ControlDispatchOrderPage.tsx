...
import Maps from '@/features/control/components/Maps';
  ...
  return (
      <ControlMainTemplate>
        <div className="relative h-[calc(100vh-11rem)]">
          ...
          <div className="absolute right-4 top-4 bottom-4 w-96 bg-white/40 backdrop-blur-sm rounded-lg overflow-y-auto">
            <div className="p-4">
              <h2 className="text-xl font-bold mb-4">인근 소방서 목록</h2>

              <div className="p-4 mb-4 bg-rose-50/90 rounded-lg border border-rose-200">
