...
public class SecurityConfig {
    ...
    public AuthenticationManager authenticationManager() {
        ...
        return new ProviderManager(Arrays.asList(userProvider, adminProvider));
    }
    @Bean
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .addFilterAt(new UserLoginFilter(authenticationManager(), jwtUtil),
                        UsernamePasswordAuthenticationFilter.class)
                .addFilterAt(new AdminLoginFilter(authenticationManager(),jwtUtil),
                        UsernamePasswordAuthenticationFilter.class);
