package c207.camference.api.contoller.dispatchstaff;

import c207.camference.api.response.dispatchstaff.AvailableHospitalResponse;
import c207.camference.api.service.dispatchstaff.DispatchStaffService;
...
@RequestMapping("/dispatch_staff/emergency_room")
public class DispatchStaffApiController {
