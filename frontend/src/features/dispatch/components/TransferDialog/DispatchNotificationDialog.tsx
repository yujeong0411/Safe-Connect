    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[600px] p-8 bg-dialog_color">
        <DialogTitle className="text-2xl font-bold mb-2">출동 지령 도착</DialogTitle>
          ...
          <Button
            className="flex-1 bg-banner hover:bg-banner text-white py-6 text-base"
            onClick={onVideoCall}
            >
          ...
          <Button
          className="flex-1 bg-white hover:bg-gray-50 text-banner border-2 border-banner py-6 text-base"
