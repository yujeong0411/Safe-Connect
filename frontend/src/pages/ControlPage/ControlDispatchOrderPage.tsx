        ...
        <ControlMainTemplate>
          <div className="relative h-screen">
            ...
            <div className="absolute inset-0">
              <KakaoMap FindFireStations={setFireStations} onMarkerClick={handleMarkerClick}
                        selectedStation={selectedStation}/>
            </div>

            {/* 소방서 목록 패널 */}
            <div
                className="absolute right-4 top-4 bottom-4 w-96 bg-white/60 rounded-lg overflow-y-auto z-10 hide-scrollbar">
